...
## 核心判断
- 拉新靠“有趣”，让人第一次进来就想点。
- 留存靠“有用”，让人第二次回来是因为真能解决事。
- 口碑靠“有结果”，让人愿意推荐给别人。
- 破圈靠“可分享”，让别人一眼看懂这产品很特别。

## 拓展
- 某次openclaw任务的回放,(另外再加视频录制?)。
- 小人跟NPC的有趣对话。
- 推荐阵容：用户只说目标，系统帮他选人、选技能、选流程。
- 成果卡：每轮任务结束都给出清晰产物、摘要、文件、链接。
- 今日战报：把日志变成可读、可分享的“今天 AI 团队做了什么”。
- 其他Agent的对接入口。
- 要围绕“协作效率”而不是堆按钮。比如任务排队与优先级、共享知识库、结果评估与复盘、多人协作审批、成本/耗时透明化。
- 做分享模式: 公开 demo 小镇、任务回放短链、模板市场、Agent 人设包、技能包，这些会比单纯再加一个页面更容易带来新用户。
- 模板市场：让别人复用“玩法”，而不是只看“界面”。

## 某不知名用户需求
- 哲学三问: 早餐吃什么 中午吃什么 晚饭吃什么
- 上班打开 电脑 帮我整理这一天需要做什么
- 然后各种 agent 开始整理任务 嘎嘎写
